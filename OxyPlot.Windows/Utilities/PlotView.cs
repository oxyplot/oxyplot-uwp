...
namespace OxyPlot.Windows
{
    ...
    public class PlotView : Control, OxyPlot.IPlotView
    {
        /// <summary>
        ...
        /// update a plot view.
        /// </summary>
        /// <param name="updateData">if the data in a plot view must be updated.</param>
        ...
        /// Show a tracker.
        /// </summary>
        /// <param name="trackerHitResult"></param>
        ...
        private void UpdateVisuals()
        {
            ...
            if (this.ActualModel != null)
            {
                ((IPlotModel)this.ActualModel).Render(this.renderContext, ClientArea);
            }
        }
